...
skills.</p>
            <div className='flex mt-8 gap-2'>
                <div className='flex items-center justify-center'>
                    <button className='neno-button shadow-xl hover:shadow-pink-200/50 text-white border-2 hover:bg-pink-500 border-with rounded-lg py-4 px-8 uppercase relative overflow-hidden'><a href=""></a></button>
                </div>
            </div>
        </div>
