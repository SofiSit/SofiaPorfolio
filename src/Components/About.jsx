...
const About = () => {
  return (
    ...
    <div id="About"  className='lg:px-56 px-10 lg:py-0 py-40 text-center gap-5 lg-text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center'>
...
skills.</p>
      ...
      <img data-aos="fade-down" src={img} width={290} height={290} className='rounded-full p-1 img_glow  ' />
    </div>
  )
}
